...
export const siteConfig = {
  ...
  about: {
    ...
    notes: [
      "16 квітня 2024 — у Запоріжжі відкрився перший Seven: український крафт, закуски та спортивні трансляції.",
      "29 березня 2025 — Seven відкрився на Володимира Великого у Львові, поєднавши дружні зустрічі та сімейний відпочинок.",
      "21 лютого 2026 — третій Seven відкрився на Площі Ринок із неаполітанською піцою з дров’яної печі.",
      "14 серпня 2026 — відкрився четвертий Seven на Хімічній із Josper-меню та стравами на відкритому вогні.",
    ],
