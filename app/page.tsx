  ...
  return (
    <>
      ...
      <section className="bg-seven-background py-24">
        <AnimatedSection className="container-shell">
          <div className="relative overflow-hidden rounded-[8px] bg-black premium-border">
            ...
            <div className="relative z-10 grid gap-10 p-6 md:p-10 lg:grid-cols-[1.05fr_0.95fr] lg:p-14">
              <div>
              ...
              <div className="flex flex-col justify-end">
                <div className="grid gap-3 sm:grid-cols-2">
                  {upcomingLocation.features.map((feature) => (
                    <article key={feature.title} className="rounded-[8px] bg-seven-card/85 p-5 premium-border backdrop-blur-sm">
      ...
      <section className="wood-grain bg-seven-background py-24">
        <AnimatedSection className="container-shell grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="group overflow-hidden rounded-[8px] premium-border">
            <ImageFrame src="/images/gallery/gallery-03.jpg" alt="Вечірня атмосфера Seven Restopub" className="aspect-[4/5] md:aspect-[16/11] lg:aspect-[4/5]" sizes="(min-width: 1024px) 50vw, 100vw" />
          </div>
          <div>
            <SectionTitle
              eyebrow="About Seven"
      ...
      <section className="bg-seven-background py-24">
        <AnimatedSection className="container-shell">
          <div className="grid overflow-hidden rounded-[8px] bg-seven-card premium-border lg:grid-cols-[1.05fr_0.95fr]">
            <div className="group relative min-h-[420px] overflow-hidden md:min-h-[560px]">
