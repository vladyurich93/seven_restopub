      ...
      <div className="container-shell">
        ...
        <div className="mt-12 grid gap-7">
          {about.notes.map((text, index) => (
            <article key={text} className="grid overflow-hidden rounded-[8px] bg-seven-card premium-border premium-lift hover:shadow-glow min-[1200px]:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="mt-8 rounded-[8px] bg-black p-7 premium-border md:p-10">
          ...
          <div className="grid gap-3 sm:grid-cols-2 min-[1200px]:grid-cols-3">
