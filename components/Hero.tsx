...
export function Hero() {
  return (
    <section className="relative min-h-[100svh] overflow-hidden bg-seven-background md:min-h-[760px] lg:min-h-[100svh]">
      <img
      ...
      <div className="container-shell relative z-10 grid min-h-[100svh] items-center gap-8 pb-12 pt-24 md:min-h-[760px] md:pb-14 md:pt-28 lg:min-h-[100svh] lg:grid-cols-[minmax(0,0.92fr)_minmax(320px,0.7fr)] lg:gap-8 lg:pb-12 lg:pt-28 xl:grid-cols-[minmax(0,0.9fr)_minmax(420px,0.76fr)] xl:gap-12 [@media_(min-width:768px)_and_(max-width:1199px)]:items-end [@media_(min-width:768px)_and_(max-width:1199px)]:pb-14 [@media_(min-width:1024px)_and_(max-height:780px)]:gap-7 [@media_(min-width:1024px)_and_(max-height:780px)]:pb-8 [@media_(min-width:1024px)_and_(max-height:780px)]:pt-24">
        <div className="min-w-0 max-w-4xl">
          ...
          <h1 className="font-display text-[clamp(3rem,12vw,6.5rem)] font-black leading-[0.9] text-white md:max-w-5xl [@media_(min-width:768px)_and_(max-width:1199px)]:max-w-3xl [@media_(min-width:768px)_and_(max-width:1199px)]:text-[clamp(4.1rem,9vw,5.8rem)] lg:text-[clamp(4.45rem,6.3vw,6.35rem)] [@media_(min-width:1024px)_and_(max-height:780px)]:text-[clamp(3.85rem,5.35vw,5.55rem)]">
        ...
        <div className="group relative hidden min-h-[460px] overflow-hidden rounded-[8px] premium-border shadow-[0_28px_80px_rgba(0,0,0,0.38)] lg:block xl:min-h-[580px] [@media_(min-width:1024px)_and_(max-width:1199px)]:min-h-[420px] [@media_(min-width:1024px)_and_(max-height:780px)]:min-h-[430px] [@media_(min-width:1024px)_and_(max-height:680px)]:min-h-[360px]">
          <img
