...
const variants = {
  ...
  secondary: "bg-seven-cream text-seven-background premium-border shadow-[0_14px_36px_rgba(246,236,221,0.08)] hover:bg-white",
  ghost: "bg-white/[0.03] text-white premium-border hover:bg-white/10",
};
